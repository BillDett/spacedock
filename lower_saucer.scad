...
module lower_saucer() {
    ...
    tube(h=rim_depth, or=rim_outer_radius*.95, ir=rim_inner_radius);    // Bottom flat 'rim'
    translate([0,0,(lower_saucer_height/2.2)])          // "cone"
        tube(h=lower_saucer_height, or1=lower_saucer_top_radius, or2=lower_saucer_bottom_radius, wall=wall);
